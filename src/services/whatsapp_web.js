  ...
  async sendMessage(phoneNumber, message) {
    try {
      if (this.autenticated) {
        ...
        await this._client.sendMessage(chatId, message).then(e => console.log(e)).catch(e=> console.log(e));
      } else {
        throw Exception('Obrigatório estar autenticado para o envio de mensagem');
      }
    } catch (e) {
